...
public class AcronymProvider extends ContentProvider {
        ...
        case ACRONYMS:
            ...
            try {
                ...
                for (ContentValues value : contentValues) {
                    final long id = db.insert(AcronymContract.AcronymEntry.TABLE_NAME,"",value);
                    if (id != -1) returnCount++;
                }
    ...
    public Cursor query(Uri uri,
        ...
        case ACRONYM: 
            ...
            retCursor = db.query(AcronymContract.AcronymEntry.TABLE_NAME, projection, selection, new String[]{rowId}, null, null, sortOrder);
            break;
        default:
            throw new UnsupportedOperationException("Unknown uri: " 
                                                    + uri);
